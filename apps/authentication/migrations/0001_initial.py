    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrateur'), ('MAGISTRATE', 'Magistrat'), ('GUARD', 'Agent pénitentiaire'), ('SOCIAL', 'Agent social')], default='GUARD', max_length=10, verbose_name='rôle')),
